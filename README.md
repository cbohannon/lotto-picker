...
Pick 6 numbers (1–54) manually or use Quick Pick for random selection, then click **Play**. The simulator runs drawings continuously at a selectable speed (100ms, 10ms, 1ms, or Turbo), tracking how many times you match 3, 4, 5, or all 6 numbers. It stops automatically when you hit the jackpot (6 of 6), or you can stop it manually.
